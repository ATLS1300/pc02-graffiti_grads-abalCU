{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "rainbow_backwards = [\"red\", \"orange\", \"yellow\", \"green\", \"blue\", \"indigo\", \"violet\"]\n",
    "rainbow_backwards.reverse()"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    "for i in reversed(rainbow_backwards):\n",
    "  print(i)"
   ]
  },
  {
